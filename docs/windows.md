# Windows build and portable ZIP (v0.4.0)

The v0.4.0 Windows target is Windows 10 (1809+) / Windows 11 x86_64,
...
./scripts/windows/test-package.ps1 -Archive ./build/packages/OpenECE-v0.4.0-windows-x86_64.zip
```
...
CI uploads `OpenECE-v0.4.0-windows-x86_64` containing the runnable ZIP. A separate
