...
Copy-Item "$DependenciesRoot/sources/json-3.12.0/LICENSE.MIT" "$notices/nlohmann-json/"
Copy-Item "$DependenciesRoot/sources/json-3.12.0/include/nlohmann/thirdparty/hedley/hedley.hpp" "$notices/nlohmann-json/"
